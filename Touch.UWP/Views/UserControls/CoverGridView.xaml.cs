...
{
    public sealed partial class CoverGridView
    {
        public CoverGridView()
        {
            InitializeComponent();
        }
        ...
        private void GridViewItem_PointerEntered(object sender, PointerRoutedEventArgs e)
        {
            ...
            var mask = rootGrid.Children[1] as FrameworkElement;
            ToggleItemPointAnimation(image, mask, true);
        }
        ...
        private void GridViewItem_PointerExited(object sender, PointerRoutedEventArgs e)
        {
            ...
            var image = rootGrid.Children[0] as FrameworkElement;
            var mask = rootGrid.Children[1] as FrameworkElement;
            ToggleItemPointAnimation(image, mask, false);
        }
        ...
        private static void ToggleItemPointAnimation(FrameworkElement image, UIElement mask, bool ifShow)
        {
            ...
            var fadeAnimation = AnimationHelper.CreateOpacityAnimation(mask, !ifShow, 2000);
