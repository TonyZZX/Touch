...
{
    public sealed partial class PlacesPage
    {
        private static int _persistedItemIndex = -1;

        private static PlacesViewModel _viewModel = new PlacesViewModel();
        ...
        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (e.NavigationMode != NavigationMode.Back)
            {
                ...
                {
                    _viewModel = new PlacesViewModel();
                    CoverGridView.ItemsSource = _viewModel.Covers;
        ...
        private void CoverGridView_OnItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            Frame.Navigate(typeof(PlaceDetailPage), e.ClickedItem);
        }
    }
}