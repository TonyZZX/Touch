...
namespace Touch.Helpers
{
    ...
    public class PropertyChangedHelper<T> : PropertyChangedHelper where T : class, new()
    {
        protected T This;

        public PropertyChangedHelper(T thing = null)
        {
            This = thing ?? new T();
        }

        public static implicit operator T(PropertyChangedHelper<T> thing)
        {
            return thing.This;
        }
    }
